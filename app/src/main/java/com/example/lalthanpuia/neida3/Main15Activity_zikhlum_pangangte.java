...
public class Main15Activity_zikhlum_pangangte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main15_zikhlum_pangangte);
    ...
    public void zikhlumhri2Click(View view) {
        Intent intent = new Intent(this,img_zikhlum_pangangte.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: fragment = new zikhlum_pangangte();break;
                case 1: fragment = new zikhlum_pangangte_tihchhiatdan();break;
