...
public class Main4Activity_aHnahRau extends AppCompatActivity {
    ...
    public void thingfanghmaNatna3CLick(View view) {
        Intent intent = new Intent(this,img_thingfanghma_aHnahRau.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: fragment = new a_hnah_rau_landan();break;
                case 1: fragment = new a_hnah_rau_enkawldan();break;
            }
            return fragment;
        }
