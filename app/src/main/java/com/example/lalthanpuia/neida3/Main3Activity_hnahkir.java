...
public class Main3Activity_hnahkir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_hnahkir);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: fragment = new a_hnah_kir_landan();break;
                case 1: fragment = new a_hnah_kir_enkawldan();break;
            }
            return fragment;
        }
