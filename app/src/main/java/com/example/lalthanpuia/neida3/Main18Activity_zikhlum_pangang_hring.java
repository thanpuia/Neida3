...
public class Main18Activity_zikhlum_pangang_hring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main18_zikhlum_pangang_hring);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar().setTitle(R.string.z9);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WhatsApp send = new WhatsApp(Main18Activity_zikhlum_pangang_hring.this);
                send.whatsappSend();
            }
        });
    ...
    public void zikhlum_hri5_Click(View view) {
        Intent intent = new Intent(this,img_zikhlum_pangangHring.class);
