...
public class Main49Activity_purunsen_lung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main49_purunsen_lung);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar().setTitle(R.string.p9);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //          .setAction("Action", null).show();
                ...
                WhatsApp send = new WhatsApp(Main49Activity_purunsen_lung.this);
                send.whatsappSend();
            }
        });
    ...
    public void purunhri3Click(View view) {
        Intent intent = new Intent(this,img_purun_lung.class);
